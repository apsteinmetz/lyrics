...
do_want %>% mutate(want=reorder(want,n)) %>% 
  ggplot(aes(want,n)) + geom_col(fill="darkgrey")+coord_flip() +
...
Finally we put it all together in a somewhat cramped plot.
